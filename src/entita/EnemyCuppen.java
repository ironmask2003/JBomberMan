...
public class EnemyCuppen extends Enemy {
	...
	public EnemyCuppen(GamePanel gp) {
		this.gp = gp;
	...
	public EnemyCuppen(GamePanel gp, int worldX, int worldY) {
	...
	public void getImageEnemy() {
		...
		try {
			...
			down1 = ImageIO.read(getClass().getResourceAsStream("/cuppen/Enemy4_im1.png"));
			down2 = ImageIO.read(getClass().getResourceAsStream("/cuppen/Enemy4_im2.png"));
			left1 = ImageIO.read(getClass().getResourceAsStream("/cuppen/Enemy4_im3.png"));
			left2 = ImageIO.read(getClass().getResourceAsStream("/cuppen/Enemy4_im4.png"));
			up1 = ImageIO.read(getClass().getResourceAsStream("/cuppen/Enemy4_im5.png"));
			up2 = ImageIO.read(getClass().getResourceAsStream("/cuppen/Enemy4_im6.png"));
			rigth1 = ImageIO.read(getClass().getResourceAsStream("/cuppen/Enemy4_im7.png"));
			rigth2 = ImageIO.read(getClass().getResourceAsStream("/cuppen/Enemy4_im8.png"));
	...
	// Aggiornamento dell'imamgine del nemico e della sua posizione prima di essere sconfitot
	public void updateBeforeDeath() {
		...
		if(System.nanoTime() > delay) {
			...
			case "rigth" : direction = "up"; break;
			}
			
			double delayDirection = (Math.random() * 5)  * (1 * Math.pow(10, 9));
			
			delay = System.nanoTime() + delayDirection;
		}
	...
	// Metodo che aggiorna lo sprites da disegnare
	...
	// Metodo che aggiorna il nemico quando viene sconfitto
	public void updateAfterDeath() {
		updateAnimation();
	}
	
	// Metodo che aggiorna la posizione e lo spirtes del nemico
	public void update() {
	...
	// Metodo che disegna il nemico prima di essere sconfitto
