...
public class SecondStage extends StartStage{
	...
	public SecondStage(GamePanel gp) {
		super();
	...
	public void getImageNumbers() {
		...
		try {
			...
			number2 = ImageIO.read(getClass().getResourceAsStream("/numbersStage/Tiles_Two.png"));
	...
	public void draw(Graphics g, boolean ok) {
		...
		if(System.nanoTime() > delay) {
			...
			if(x == 600) { endSecondTransition = true; gp.back.loop();} // Se la scritta è scompara imposta la variabile a true
